...
Section: devel
Priority: extra
Depends: binutils`'TS (>= ${binutils:Version}), ${dep:libcbiarchdev}, ${dep:libcdev}, ${dep:libunwinddev}, ${shlibs:Depends}
Provides: c++abi2-dev
...
Section: devel
Priority: PRI(optional)
Depends: BASEDEP, binutils-spu (>= 2.18.1~cvs20080103-3), ${shlibs:Depends}
Recommends: newlib-spu
Conflicts: spu-gcc
Provides: spu-gcc
Replaces: spu-gcc
...
Description: The D compiler
 ...
 .
 For more information check http://dgcc.sourceforge.net/
')`'dnl d
